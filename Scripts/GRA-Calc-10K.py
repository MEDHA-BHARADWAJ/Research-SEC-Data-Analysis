...
### Run this script to go through every 10K and compute Customer Metric ###
...
def newFileNameGenerator(compId,fileName):
    ...
    index = 0
    for line in lines:
        if 'FILED AS OF DATE:' in line:#"CONFORMED PERIOD OF REPORT:" in line:
...
def fileCleaner(fileName, bagOfWords):
    ...
    print("after beautiful soup:",len(cleantext))
    ...
    #tmp_file = open("C:/Users/medha/OneDrive/Desktop/GMU/GRA/Financial Data/tmp2.txt", "w")
    ...
    #tmp_file = open("C:/Users/medha/OneDrive/Desktop/GMU/GRA/Financial Data/tmp3.txt", "w")
...
def createData():
    ...
    dataFile = open("C:/Users/medha/OneDrive/Desktop/GMU/GRA/Financial Data/10K-DataFile","w")
    ...
    for comp in compList:
        fileList = [os.path.normpath(i) for i in glob.glob("C:/Users/medha/OneDrive/Desktop/GMU/GRA/Financial Data/sec-edgar-filings/"+comp[1]+"/10-K/*/full-submission.txt")]
        print(fileList)
        for file in fileList:
            ...
            print(row)
    finalDf.to_excel("C:/Users/medha/OneDrive/Desktop/GMU/GRA/10K-output.xlsx")
    print("Done")
